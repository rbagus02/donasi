...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="/{{$user->id}}/simpan-profil-pengguna" method="POST">
                @csrf
                <p>Nama Pengguna</p>
                <div class="input-group">
                    <input type="text" name="name" class="form-control" value="{{$user->name}}" placeholder="Masukkan Nama" aria-describedby="basic-addon2">
                </div>
                <br>
                <p>Username</p>
                <div class="input-group">
                    <input type="text" name="username" class="form-control" value="{{$user->username}}" aria-describedby="basic-addon2" readonly>
                </div>
                <br>
                <p>Password</p>
                <div class="input-group">
                ...
                <p>Nomor Telepon</p>
                <div class="input-group">
                    <input type="text" name="nomor_telp" class="form-control" value="{{$user->nomor_telp}}" placeholder="Masukkan Nomor Telepon" aria-describedby="basic-addon2">
                </div>
                <br>
                <p>Alamat</p>
                <div class="input-group">
